...
console.log("1. Kill process 14960 using port 3002:");
console.log("   Get-Process -Id 14960 | Stop-Process -Force");
console.log("2. Start dev server: npm run dev");
console.log("3. Open http://localhost:3002/tools/pdf-editor");
console.log("4. Upload a PDF and test text replacement");
console.log("   Expected: No 'arguments required' error, seamless vector-based text replacement\n");
